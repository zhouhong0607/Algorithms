...
public class Alphabet
{
	 ...
	 *             unless <tt>c</tt> is a character in this alphabet
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             unless every character in <tt>s</tt> is a character in this
	 *             alphabet
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             unless <tt>index</tt> is between <tt>0</tt> and
	 *             <tt>R - 1</tt>
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             unless every index is between <tt>0</tt> and <tt>R - 1</tt>
	 */
